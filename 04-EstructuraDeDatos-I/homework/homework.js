...
nFibonacci(n) debe retornar el enésimo número de la secuencia de Fibonacci, tomando al 0 y al 1, respectivamente, como primer y segundo elementos de 
la misma, y sabiendo que cualquier elemento que se agregue a esta secuencia será el resultado de la suma del último elemento y el anterior.
...
function nFactorial(n) {
  ...
  if(n === 0 || n === 1) return 1;
  // VALIDACION
  if( n < 0 ) return "No se puede facto un negativo!";
  // RECURSION
